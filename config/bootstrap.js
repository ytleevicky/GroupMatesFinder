...
module.exports.bootstrap = async function () {
  ...
  if (await User.count() == 0) {
    ...
    await User.createEach([
      ...
      // Real Email Testing (1-4)
      { givenId: '17227337', password: hash, role: 'student', preferred_name: 'Jonas Wong', fullName: 'WONG Ming Hong', gender: 'Male', contact_mobile: '9930 2338', contact_mail: 'fyp.demostudent1@gmail.com', study_year: 3, study_programme: "Bachelor of Computer Science", imgURL: "/images/user4.png" },
      ...
      { givenId: '17555666', password: hash, role: 'student', preferred_name: 'Isaac Lee', fullName: 'LEE Chi Ming', gender: 'Male', contact_mobile: '9877 2900', contact_mail: 'fyp.demostudent2@gmail.com', study_year: 4, study_programme: "Bachelor of Architecture", imgURL: "/images/user5.png" },
      { givenId: '18222333', password: hash, role: 'student', preferred_name: 'Rachel Yu', fullName: 'YU Wing San', gender: 'Female', contact_mobile: '9981 2244', contact_mail: 'ytleevicky@gmail.com', study_year: 3, study_programme: "Bachelor of Business", imgURL: "/images/user2.png" },

      { givenId: '19333444', password: hash, role: 'student', preferred_name: 'Tina Cheung', fullName: 'CHEUNG Hoi Ting', gender: 'Female', contact_mobile: '9772 2286', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 2, study_programme: "Bachelor of Music", imgURL: "/images/user3.png" },
      { givenId: '20331441', password: hash, role: 'student', preferred_name: 'Barry Lam', fullName: 'LAM Pui Kin', gender: 'Male', contact_mobile: '9933 2277', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 1, study_programme: "Bachelor of Accountancy", imgURL: "/images/user6.png" },
      { givenId: '17111333', password: hash, role: 'student', preferred_name: 'George Wong', fullName: 'WONG Lok Man', gender: 'Male', contact_mobile: '9811 2233', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 4, study_programme: "Bachelor of Design", imgURL: "/images/user4.png" },
      { givenId: '18000111', password: hash, role: 'student', preferred_name: 'Harris Ko', fullName: 'KO Ho Yuen', gender: 'Male', contact_mobile: '9772 2388', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 3, study_programme: "Bachelor of Administrative Studies", imgURL: "/images/user5.png" },
      { givenId: '19222666', password: hash, role: 'student', preferred_name: 'Louis Chan', fullName: 'CHAN Tin Ho', gender: 'Male', contact_mobile: '9654 1234', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 2, study_programme: "Bachelor of Journalism", imgURL: "/images/user6.png" },
      { givenId: '17999888', password: hash, role: 'student', preferred_name: 'Howard Cheung', fullName: 'CHEUNG Yat Kin', gender: 'Male', contact_mobile: '9933 1338', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 3, study_programme: "Bachelor of Computer Science", imgURL: "/images/user4.png" },
      { givenId: '20333555', password: hash, role: 'student', preferred_name: 'Bonnie Tam', fullName: 'TAM Hoi Ki', gender: 'Female', contact_mobile: '6623 2900', contact_mail: 'fyp.demostudent3@gmail.com', study_year: 1, study_programme: "Bachelor of Science in Nursing", imgURL: "/images/user1.png" },
